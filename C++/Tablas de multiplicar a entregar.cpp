...
int main(int argc, char** argv) 
{
	...
	int numero, contador, tabla, numerito;//asigno el valor de integral a las constantes numero, contadot y tabla
	...
	while (continuar=='s'){//inicio el ciclo de while o mientras, donde todo se repetira mientras continuar sea igual a "s"
		...
		for(contador =0; numerito; contador+=1)//inicia el proceso para donde contador es igual a cero, y hara la cuenta hasta 11, dando saltos en contador de uno en uno
